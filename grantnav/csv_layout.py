...
grants_csv = OrderedDict([
    ...
    ("Funding Org: Canonical Org ID", "result.additional_data.recipientOrganizationCanonical.id"),
    ("Funding Org: Canonical Name", "result.additional_data.recipientOrganizationCanonical.name"),
    ...
    ("Recipient Org: Canonical Org ID", "result.additional_data.recipientOrganizationCanonical.id"),
    ("Recipient Org: Canonical Name", "result.additional_data.recipientOrgInfos.recipientOrganizationCanonical.name"),
