...
grants_csv = OrderedDict([
    ...
    ("Award Date (date only)", "result.awardDateDateOnly"),
    ("URL", "result.recipientOrganization.0.url"),
    ("Planned Dates:Start Date", "result.plannedDates.0.startDate"),
    ("Planned Dates:Start Date (date only)", "result.plannedDates.0.startDateDateOnly"),
    ("Planned Dates:End Date", "result.plannedDates.0.endDate"),
    ("Planned Dates:End Date (date only)", "result.plannedDates.0.endDateDateOnly"),
    ("Planned Dates:Duration (months)", "result.plannedDates.0.duration"),
    ("Actual Dates:Start Date", "result.actualDates.0.startDate"),
    ("Actual Dates:Start Date (date only)", "result.actualDates.0.startDateDateOnly"),
    ("Actual Dates:End Date", "result.actualDates.0.endDate"),
    ("Actual Dates:End Date (date only)", "result.actualDates.0.endDateDateOnly"),
    ...
    ("Recipient Region", "result.recipientRegionName"),
    ("Recipient District", "result.recipientDistrictName"),
    ("Recipient District Geographic Code", "result.recipientDistrictGeoCode"),
    ("Recipient Ward", "result.recipientWardName"),
    ("Recipient Ward Geographic Code", "result.recipientWardNameGeoCode"),
    ("Retrieved for use in GrantNav", "dataset.datagetter_metadata.datetime_downloaded"),
