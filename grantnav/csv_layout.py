...
grants_csv = OrderedDict([
    ...
    ("Funding Org: Canonical Org ID", "result.additional_data.fundingOrganizationCanonical.id"),
    ("Funding Org: Canonical Name", "result.additional_data.fundingOrganizationCanonical.name"),
    ...
    ("Recipient Org: Canonical Name", "result.additional_data.recipientOrganizationCanonical.name"),
