...
urlpatterns = [
    ...
    url(r'^funder/(.*)/recipients.csv$', views.funder_recipients_download, name='funder_recipients_download.csv'),
    url(r'^funder/(.*)/recipients.json$', views.funder_recipients_download, name='funder_recipients_download.json'),
