...
TERM_FACETS = [
    ...
    TermFacet("additional_data.GNBeneficiaryRegionName", "beneficiaryRegionName", 15, "Beneficiary Region Name", False, 5000),
    TermFacet("additional_data.GNRecipientOrgRegionName", "recipientOrgRegionName", 16, "Recipient Organisation Region Name", False, 5000),
    TermFacet("additional_data.GNBeneficiaryDistrictName", "beneficiaryDistrictName", 17, "Beneficiary District Name", False, 5000),
    TermFacet("additional_data.GNRecipientOrgDistrictName", "recipientOrgDistrictName", 18, "Recipient Organisation Region Name", False, 5000),
]
